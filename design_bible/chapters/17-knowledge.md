...
## Purpose
Knowledge is a first-class domain within Perch and follows the principles defined by the Design Bible.

## Primary Question
**What does Perch know that can help me?**

## Design Intent
This chapter defines the user experience, responsibilities, and architectural boundaries for the Knowledge domain.
